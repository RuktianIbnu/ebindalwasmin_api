...
func (m *usecase) GetKelaminPer10hari(date1 int64, date2 int64) (result []*model.IntalPermohonanperKelaminPer10hari, err error) {
	return m.intalRepo.GetKelaminPer10hari(date1, date2)
}
